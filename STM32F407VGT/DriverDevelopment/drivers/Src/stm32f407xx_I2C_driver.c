	...
	if(pI2CHandle->pI2Cx->I2C_SR2 & ( 1 << I2C_SR2_MSL))
	{
		...
		if(pI2CHandle->TxRxState == I2C_BUSY_IN_RX)
		{
			if(pI2CHandle->RxSize  == 1)
			{
				...
				//clear the ADDR flag ( read I2C_SR1 , read SR2)
...
void I2C_PeripheralControl(I2C_RegDef_t *pI2Cx, uint8_t EnOrDi)
{
	if(EnOrDi == ENABLE)
	{
		...
		//pI2cBaseAddress->I2C_CR1 |= I2C_I2C_CR1_PE_Bit_Mask;
	}else
	{
		pI2Cx->I2C_CR1 &= ~(1 << 0);
	}
...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
	...
	//configure the FREQ field of I2C_CR2
	tempreg = 0;
...
void I2C_MasterSendData(I2C_Handle_t *pI2CHandle,uint8_t *pTxbuffer, uint32_t Len, uint8_t SlaveAddr,uint8_t Sr)
{
	...
	//2. confirm that start generation is completed by checking the SB flag in the I2C_SR1
	...
	//4. Confirm that address phase is completed by checking the ADDR flag in teh I2C_SR1
...
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle,uint8_t *pRxBuffer, uint8_t Len, uint8_t SlaveAddr,uint8_t Sr)
{
	...
	//4. wait until address phase is completed by checking the ADDR flag in teh I2C_SR1
	while( !  I2C_GetFlagStatus(pI2CHandle->pI2Cx,I2C_FLAG_ADDR)   );
...
void I2C_EV_IRQHandling(I2C_Handle_t *pI2CHandle)
{
	...
	{
		//STOF flag is set
		//Clear the STOPF ( i.e 1) read I2C_SR1 2) Write to I2C_CR1 )
...
void I2C_ER_IRQHandling(I2C_Handle_t *pI2CHandle)
{
    ...
    //Know the status of  ITERREN control bit in the I2C_CR2
